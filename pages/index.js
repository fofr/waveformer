    ...
    <div>
      <div className="container max-w-4xl mx-auto px-8 py-4 pb-10 bg-white border-black min-h-screen">
        ...
        <p className="text-center mb-10 -mt-2 text-2xl">
          Make music from text with <Link className="hover:bg-violet-900 underline underline-offset-4 hover:no-underline bg-black text-white px-2 py-1 rounded" href="https://github.com/facebookresearch/audiocraft#musicgen">MusicGen</Link> and <Link href="https://replicate.com/joehoover/musicgen-melody" className="hover:bg-violet-900 underline underline-offset-4 hover:no-underline bg-black text-white px-2 py-1 rounded">Replicate</Link>
        </p>
